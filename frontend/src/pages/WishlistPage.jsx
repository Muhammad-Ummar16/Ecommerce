...
const WishlistPage = () => {
    ...
    if (wishlistItems.length === 0) {
        return (
            <div className="bg-[#f8f5f2] min-h-screen font-sans">
                <NavBar />
                <div className="pt-32 pb-20 min-h-[70vh] flex flex-col items-center justify-center px-4 animate-fade-in text-center">
    ...
    return (
        <div className="bg-[#f8f5f2] min-h-screen font-sans">
            <NavBar />
            <div className="pt-32 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in">
                <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12 border-b border-[#3D3028]/10 pb-12">
                    <div>
