    ...
    if (cartItems.length === 0) {
        return (
            <div className="bg-[#f8f5f2] min-h-screen font-sans">
                <NavBar />
                <div className="pt-32 pb-20 min-h-[70vh] flex flex-col items-center justify-center px-4 animate-fade-in">
                    <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mb-6 shadow-sm">
                        <ShoppingBag className="w-10 h-10 text-gray-300" />
                    </div>
                    <h2 className="text-3xl font-black text-[#3D3028] uppercase tracking-tight mb-2 text-center md:text-left">Your Cart is Empty</h2>
