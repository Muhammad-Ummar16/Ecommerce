...
const AuthLayout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen bg-[#FDFBF9] flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans overflow-hidden relative selection:bg-[#3D3028] selection:text-white">
